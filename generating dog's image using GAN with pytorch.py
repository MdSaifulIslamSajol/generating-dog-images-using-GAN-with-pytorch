# -*- coding: utf-8 -*-
"""
Created on Tue Oct  4 00:00:17 2022
...
# Dataloader
train_data = datasets.ImageFolder("./alldogs_Images", transform = transform)
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        Real_Loss = criterion(output.float(), labels.float())   # Calculate loss
